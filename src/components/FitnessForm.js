    ...
    return (
        <div className="fitness-form">
            <div className="fitness-form__container">
                ...
                <p className="fitness-form__container__body">Lets plan your meals! Meal Planner & Grocery List for make your week easier is perfect to track your meal .Contains a box space for every day of the week and a page for each grocery list.</p>
            </div>
        </div>
    );
}
